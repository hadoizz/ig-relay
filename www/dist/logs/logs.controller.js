...
let LogsController = class LogsController {
    ...
    async getFollowedCounts(accountId, req) {
...
], LogsController.prototype, "getJobs", null);
__decorate([
    common_1.UseGuards(passport_1.AuthGuard('jwt')),
    common_1.Get('/account/:accountId/followedCounts'),
    __param(0, common_1.Param('accountId')), __param(1, common_1.Request()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Object]),
    __metadata("design:returntype", Promise)
], LogsController.prototype, "getFollowedCounts", null);
