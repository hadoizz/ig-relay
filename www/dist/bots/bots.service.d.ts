...
export declare class BotsService {
    ...
    private devBot;
    createBot(credentials: Credentials, beforeLoad?: (Slave: any) => any): Promise<{
        id: string;
        bot: {
            info: {
                startedAt: number;
            ...
            slave: Slave;
            exit(): void;
            executeSupervisor(executeSupervisorCommand: import("./utils/createBot").ExecuteSupervisorCommand): Promise<{}>;
