        ...
        switch (_a.label) {
            ...
            case 3:
                ...
                server.post('/start', function (req, res) {
                    ...
                    bot = execa_1.default.node(path_1.resolve('../bot'), ['build/app'], 
                    //@ts-ignore
                    { cwd: path_1.resolve('../bot') });
                ...
                server.get('/favicon.ico', function (req, res) { return (res.status(200).sendFile('favicon.ico', { root: __dirname + '/client/static/' })); });
